...
def linspace(lower, upper, number_of_files, file_num, *, interval_to_step=1):
    ...
    number_of_files -- number of files in Omphalos run.
    file_num -- the file number of this specific input file.
    interval_to_step -- number of steps over which to hold a specific value.
                        E.g. if you wanted to change a concentration every 3 input files instead of every 1 input file you would make this 3.
                        For example, on the range 1-10 for 10 input files: [1 1 1 3 3 3 7 7 7 10].
    """
